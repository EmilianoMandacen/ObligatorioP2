...
namespace LogicaVentas
{
    public class Sistema
    {
        ...
        {
            AltaAdministrador("Roberto", "Martínez", "roberto@ejemplo.com", "passwordAdmin1");
            AltaAdministrador("Elena", "González", "elena@ejemplo.com", "passwordAdmin2");
        }
        ...
        //($"Subasta {i - 10}", "ABIERTA", DateTime.Now.AddDays(7), articulosSubasta, (Cliente)_usuarios[i - 11], _administradores[1], ofertas);
