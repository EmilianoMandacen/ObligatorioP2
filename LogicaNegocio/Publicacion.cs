...
{
    internal abstract class Publicacion : IValidate
    {
        private int _id;
        ...
        public Publicacion(string nombre, string estado, DateTime fechaFinalizacion, List<Articulo> articulos, Cliente cliente, Usuario usuario)
        {
            _id = s_ultId++;
            _nombre = nombre;
            _estado = estado;
